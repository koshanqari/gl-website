  ...
  return (
    <AdminLayout>
      <div className="max-w-3xl mx-auto">
        <div className="mb-6">
          <h1 className="text-display-small font-bold txt-clr-black">Add New Capability</h1>
          <p className="text-body-medium txt-clr-neutral mt-1">Create a new event management capability</p>
        </div>
